...
#data['CLICK_LAG1'] = data.groupby(['STOCK_CODE'])['CLICK'].shift(1)
#data['CLICK_DIFF'] = data['CLICK'] - data['CLICK_LAG1']
#data['FAVORITE_PERCENT_LAG1'] = data.groupby(['STOCK_CODE'])['FAVORITE_PERCENT_x'].shift(1)
#data['FAVORITE_PERCENT_DIFF'] = data['FAVORITE_PERCENT_x'] - data['FAVORITE_PERCENT_LAG1']
...
for sample_stock_code in stock_pool[584:585]:
    try:
...
#plt.hist(data[magic_str].dropna(), bins='auto')  # arguments are passed to np.histogram
...
#sns.heatmap(predicted_accuracy_by_actural_value,annot=True,vmin=0,vmax=0.6)

#sns.heatmap(predicted_accuracy_no_click,annot=True,vmin=0,vmax=0.6)


#today return with click
#withclick=np.array([[15433.,  1501.,  8311.,  4265.],
#       [ 2703.,   644.,  5915.,  1958.],
#       [ 6067.,  1345., 24071.,  6027.],
#       [ 4980.,   762., 14837., 17551.]])
#            array([[0.52297526, 0.05086411, 0.28163334, 0.14452728],
#       [0.24090909, 0.0573975 , 0.5271836 , 0.1745098 ],
#       [0.16174354, 0.0358571 , 0.64172221, 0.16067715],
#       [0.13060582, 0.01998426, 0.38911618, 0.46029373]])

#today return with no click
#sum_all_stocks_no_click = np.array([[15381.,  1523.,  9497.,  3589.],
#                                    [ 2723.,   597.,  6021.,  2608.],
#                                    [ 7106.,  1146., 21124., 10312.],
#                                    [ 5377.,  1016., 18707., 14699.]])
#predicted_accuracy_no_click = np.array([[0.51287096, 0.05078359, 0.31667222, 0.11967322],
#                                        [0.22788518, 0.04996234, 0.50389154, 0.21826094],
#                                        [0.17904656, 0.02887523, 0.53225156, 0.25982665],
#                                        [0.1351039 , 0.02552828, 0.47003694, 0.36933089]])