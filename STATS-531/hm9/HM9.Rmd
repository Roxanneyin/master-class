...
stew(file=sprintf("lik_global_eval-%d.rda",run_level),{
  t_global_eval <- system.time({
    liks_global <- foreach(i=1:bsflu_Nglobal,.packages='pomp',.combine=rbind, .options.multicore=mcopts, .export = c('bsflu_Nmif','bsflu2','bsflu_box','bsflu_fixed_params','bsflu_Np','bsflu_rw.sd','bsflu_cooling.fraction.50')) %dopar% {
